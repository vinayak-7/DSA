<h2><a href="https://practice.geeksforgeeks.org/problems/length-of-last-word5721/1?utm_source=gfg&utm_medium=article&utm_campaign=bottom_sticky_on_article">Length of Last word</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string <strong>S</strong> consisting of upper/lower-case alphabets and empty space characters ‘ ‘. The string may contain spaces at the end. You will have return the length of last word which consists of alphabets only.</span></p>
