...
## Easy
<div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a doubly linked list containing <strong>N</strong> nodes. The problem is to sort the given doubly linked list.&nbsp;</span></p>
